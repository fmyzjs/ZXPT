...
(
	...
	'row_vip_by_bonus' => "贵宾资格为通过萝卜获得",
	'text_vip_by_bonus_note' => "该贵宾资格是否为通过萝卜换取。",
	'row_vip_until' => "贵宾资格结束时间",
	'text_vip_until_note' => "时间格式为'年年年年-月月-日日 时时:分分:秒秒'。贵宾资格结束的时间。'贵宾资格为通过萝卜获得'必须设为'是'此规则才能生效。",
	'row_show_ad' => "显示广告",
