...
(
	...
	'text_offer_note1' => "<a href=/forums.php?action=viewtopic&forumid=8&topicid=6><font color=brown size=+2>为了您的种子早日通过审核，请先认真学习PT规则！点击进入...
</font></a>",
	'text_offer_note2' => "<a href=/forums.php?action=viewtopic&forumid=8&topicid=7><font color=brown size=+2>发布候选前请务必阅读命名规则！点击进入...</font></a>",
	...
	'text_search_offer_note' => "<font size=+1 color=red>为避免重复发种，请务必提前搜索种子是否已经存在，确定无重复方可添加，否则请直接下载种子保种，违者重罚(根据用户等级处以扣1000至4000萝卜处罚，举报有奖)</font><br/>",
	'title_comment' => "评论",
	'col_vote_results' => "投票",
