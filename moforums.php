...
} else {print "<tr><td class=\"rowhead_left\" colspan=3>".$lang_moforums['text_no_records_found']."</td></tr>";}
echo "</table>";
?>
<br /><br />
...
<tr align="center">
    <td class="rowhead_left" colspan="2" class=colhead><?php echo $lang_moforums['text_new_overforum']?></td>
  </tr>
  <tr>
    <td class="rowhead_left" ><b><?php echo $lang_moforums['text_overforum_name']?></td>
    <td class="rowhead_left"><input name="name" type="text" style="width: 200px" maxlength="60"></td>
  </tr>
  <tr>
    <td class="rowhead_left"><b><?php echo $lang_moforums['text_overforum_description']?></td>
    <td class="rowhead_left"><input name="desc" type="text" style="width: 400px" maxlength="200"></td>
  </tr>

    <tr>
    <td class="rowhead_left"><b><?php echo $lang_moforums['text_minimum_view_permission']?></td>
    <td class="rowhead_left">
...
?>
    ...
    <tr>
    <td class="rowhead_left"><b><?php echo $lang_moforums['text_overforum_order']?></td>
    <td class="rowhead_left">
    <select name=sort>
<?php
